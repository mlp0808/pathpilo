...
const roundTemplateRoutes = require('./routes/round-templates');
const roundsRoutes = require('./routes/rounds');
const routePlannerRoutes = require('./routes/route-planner');
const mapToolRoutes = require('./routes/map');
const offerRoutes = require('./routes/offers');
const { publicRouter: publicOfferRoutes } = offerRoutes;
const guestRouteRoutes = require('./routes/guest-route');
...
app.use('/api/item-groups', require('./routes/item-groups'));
...
app.use('/api/round-templates', roundTemplateRoutes);
app.use('/api/route-planner', routePlannerRoutes);
app.use('/api/map', mapToolRoutes);
app.use('/api/offers', offerRoutes);
app.use('/api/public/offers', publicOfferRoutes);
app.use('/api/guest-route', guestRouteRoutes);
