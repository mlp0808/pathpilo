  ...
  const faqs = da
    ? [
        {
          ...
          answer:
            'PathPilo er ideel til mobile servicevirksomheder med planlægning, aftaler og flere medarbejdere. Det gælder fx rengøring, anlæg, vedligehold, VVS, el, ejendomsservice m.fl.',
        },
        {
          question: 'Hvordan fungerer gentagne opgaver?',
          answer:
            'Du kan oprette abonnementer med ugentlige eller månedlige intervaller, vælge faste dage og lade PathPilo oprette opgaver automatisk.',
        },
        {
          question: 'Kan jeg administrere flere medarbejdere og deres tider?',
          answer:
            'Ja. Du kan tilføje medarbejdere, sætte arbejdstider, tildele opgaver og bruge roller (owner/manager/employee) for adgangsstyring.',
        },
        {
          question: 'Hvordan fungerer fakturering?',
          answer:
            'Vælg afsluttede opgaver, vælg fakturatype, tilføj rabat/moms og send faktura på få minutter. Du kan også eksportere PDF.',
        },
        {
          question: 'Kan jeg få leads fra min hjemmeside?',
          answer:
            'Ja. Du kan oprette lead-formularer, dele dem via link, få notifikationer og konvertere leads direkte til kunder og opgaver.',
        },
        {
        ...
        },
        {
          ...
          answer:
            'PathPilo kan sende automatiske e-mails om bekræftelser, ændringer, aflysninger og fakturaer med skabeloner, du selv tilpasser.',
        },
        {
          question: 'Hvilke analyser og rapporter får jeg?',
          answer:
            'Du får indsigt i omsætning, opgavestatus, teamperformance og kundeadfærd med filtre på dato og mulighed for eksport.',
        },
        {
          question: 'Hvor sikker er mine data?',
          answer:
            'Vi bruger moderne sikkerhedsstandarder, adgangsstyring og backup i cloud. Dine data deles ikke med tredjeparter.',
        },
        {
    ...
    : [
        ...
        },
        {
          ...
          answer:
            'Yes! PathPilo is free to get started, so you can explore all features risk-free. No credit card required. Set up your company, add services and clients, create jobs, and see how PathPilo works for your business.',
        },
        {
          question: 'What if I need help getting started?',
          answer:
            'We provide comprehensive onboarding support. Our step-by-step setup wizard guides you through initial configuration. We also offer documentation, best practices guides, and customer support. Most businesses are up and running within an hour. If you need additional help, contact our support team.',
        },
        {
          question: 'Can I export my data if I need to?',
          answer:
            "Yes, you maintain full control of your data. You can export client information, job history, invoices, and reports at any time. We believe in data portability, so you're never locked in. Export formats include CSV and PDF for easy integration with other tools.",
        },
      ]
