      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary-700 transition-colors hover:bg-accent-500"
                aria-label="LinkedIn"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href={navHref('/tools/route-planner')} className="text-gray-300 hover:text-white transition-colors">
                  {da ? 'Gratis ruteplanlægger' : 'Free route planner'}
                </Link>
              </li>
              <li>
                <Link href={navHref('/articles')} className="text-gray-300 hover:text-white transition-colors">
